$(document).ready( function() {
    ...
    let reload = document.getElementById('re-generate'); //set button as variable
    let colorContainer = document.getElementById('sample-container'); //assign container to variable
    let runCount = 0;
